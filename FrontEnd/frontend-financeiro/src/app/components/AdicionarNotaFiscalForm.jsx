    ...
    return (
        <section className="bg-white p-2 rounded-lg shadow-md mb-1">
          ...
          <form onSubmit={handleAddNotaFiscal} className="grid grid-cols-1 md:grid-cols-6 gap-6 items-end">
            ...
            <div className="md:col-span-1">
              <label htmlFor="dataNf" className="block text-sm font-medium text-gray-700">Data da NF/CT-e</label>
            ...
            <div className="md:col-span-2">
              <label htmlFor="peso" className="block text-sm font-medium text-gray-700">Peso Líquido (Kg)</label>
              <input type="text" name="peso" value={novaNf.peso} onChange={handleInputChange} placeholder="0,00" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2"/>
            </div>
